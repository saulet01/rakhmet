...
jQuery.extend(jQuery.easing, {
  ...
  easeInExpo: function(t, e, i, n, a) {
    return 0 == e
      ? i
      : n * Math.pow(2, 10 * (e / a - 1)) + i
  },
  easeOutExpo: function(t, e, i, n, a) {
    return e == a
      ? i + n
      : n * (1 - Math.pow(2, -10 * e / a)) + i
  },
  ...
  easeInOutElastic: function(t, e, i, n, a) {
    ...
    if (o || (o = a * (.3 * 1.5)), s < Math.abs(n)) {
      ...
      r = o / (2 * Math.PI) * Math.asin(n / s);
    return e < 1
      ? s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) * -.5 + i
      : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) * .5 + n + i
  },
  ...
  easeOutBounce: function(t, e, i, n, a) {
    return (e /= a) < 1 / 2.75
      ? n * (7.5625 * e * e) + i
      : e < 2 / 2.75
        ? n * (7.5625 * (e -= 1.5 / 2.75) * e + .75) + i
        : e < 2.5 / 2.75
          ? n * (7.5625 * (e -= 2.25 / 2.75) * e + .9375) + i
          : n * (7.5625 * (e -= 2.625 / 2.75) * e + .984375) + i
  },
  easeInOutBounce: function(t, e, i, n, a) {
    return e < a / 2
      ? .5 * jQuery.easing.easeInBounce(t, 2 * e, 0, n, a) + i
      : .5 * jQuery.easing.easeOutBounce(t, 2 * e - a, 0, n, a) + .5 * n + i
  }
}),
jQuery.Velocity
    ...
    if (!t.jQuery) {
      ...
      i.dequeue = function(t, e) {
        ...
        function(t, n) {
          ...
          r && ("fx" === e && a.unshift("inprogress"), r.call(n, function() {
            i.dequeue(n, e)
          }))
        })
      },
    ...
    return function(t, e, i, n) {
                  ...
                  for (var M in c.visibility !== n && "hidden" !== c.visibility && y.setPropertyValue(S, "visibility", c.visibility), k) 
                    if ("element" !== M) {
                      ...
                      if (1 === m) 
                        ...
                        if (P = T.startValue + _ * A(m, c, _), !p && P === T.currentValue) 
                          continue
                      }
                      if (T.currentValue = P, "tween" === M) 
                        g = P;
                      else {
                        ...
                        var F = y.setPropertyValue(S, M, T.currentValue + (
                          0 === parseFloat(P)
                          ? ""
                          : T.unitType), T.rootPropertyValue, T.scrollData);
                        y.Hooks.registered[M] && (
                          r(S).rootPropertyValueCache[I] = y.Normalizations.registered[I]
                          ? y.Normalizations.registered[I]("extract", null, F[1])
                          : F[1]),
                        "transform" === F[0] && (C = !0)
                      }
                    }
                  c.mobileHA && r(S).transformCache.translate3d === n && (r(S).transformCache.translate3d = "(0px, 0px, 0px)", C = !0),
                  C && y.flushTransformCache(S)
                }
              }
              c.display !== n && "none" !== c.display && (v.State.calls[a][2].display = !1),
              c.visibility !== n && "hidden" !== c.visibility && (v.State.calls[a][2].visibility = !1),
              c.progress && c.progress.call(o[1], o[1], m, Math.max(0, h + c.duration - e), h, g),
              1 === m && u(a)
            }
          }
      ...
      function u(t, e) {
        ...
        for (var i = v.State.calls[t][0], a = v.State.calls[t][1], o = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
          ...
          if (e || o.loop || ("none" === o.display && y.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && y.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h)) {
            ...
            o.mobileHA && (f = !0, delete r(h).transformCache.translate3d),
          ...
          s && !0 !== o.loop && s(a),
          r(h) && !0 === o.loop && !e && (d.each(r(h).tweensContainer, function(t, e) {
      ...
      if (!(7 >= c)) {
        ...
        var b = function() {
          ...
          return function t(e, n, a) {
            var r,
              ...
              d = 0;
            for (
              e = parseFloat(e) || 500, n = parseFloat(n) || 20, a = a || null, l.tension = e, l.friction = n, (r = null !== a)
              ? o = (d = t(e, n)) / a * .016
              : o = .016; s = i(s || l, o), u.push(1 + s.x), d += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;) 
            ;
            return r
              ? function(t) {
        ...
        var y = v.CSS = {
          ...
          Hooks: {
            ...
            cleanRootPropertyValue: function(t, e) {
              return y.RegEx.valueUnwrap.test(e) && (e = e.match(y.RegEx.valueUnwrap)[1]),
            ...
            injectValue: function(t, e, i) {
              ...
              if (n) {
                var a,
                  r = n[0],
                  o = n[1];
                return (a = (i = y.Hooks.cleanRootPropertyValue(r, i)).toString().match(y.RegEx.valueSplit))[o] = e,
                a.join(" ")
              }
              return i
            }
                    ...
                    switch (t) {
                      ...
                      case "inject":
                        ...
                        switch (e.substr(0, e.length - 1)) {
                          ...
                          case "scal":
                          case "scale":
                            v.State.isAndroid && r(i).transformCache[e] === n && 1 > a && (a = 1),
                            o = !/(\d)$/i.test(a);
                            break;
                          case "skew":
                            o = !/(deg|\d)$/i.test(a);
                        ...
                        return o || (r(i).transformCache[e] = "(" + a + ")"),
                    ...
                    switch (t) {
                      ...
                      case "extract":
                        ...
                        if (y.RegEx.wrappedValueAlreadyExtracted.test(a)) 
                          ...
                          r = (o || a).toString().match(y.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                        }
                        return 8 >= c || 3 !== r.split(" ").length || (r += " 1"),
                        r;
                      case "inject":
                        return 8 >= c
          ...
          Names: {
            ...
            SVGAttribute: function(t) {
              ...
              return (c || v.State.isAndroid && !v.State.isChrome) && (e += "|transform"),
              new RegExp("^(" + e + ")$", "i").test(t)
            },
            prefixCheck: function(t) {
              if (v.State.prefixMatches[t]) 
                return [
                  v.State.prefixMatches[t], !0
                ];
              for (var e = [
                "", "Webkit", "Moz", "ms", "O"
                ...
                if (
                  a = 0 === i
                  ? t
                  : e[i] + t.replace(/^\w/, function(t) {
                    return t.toUpperCase()
                  }),
                f.isString(v.State.prefixElement.style[a])) 
                  return v.State.prefixMatches[t] = a,
                  [
                    a, !0
                  ]
              }
          ...
          Values: {
            ...
            getUnitType: function(t) {
              return /^(rotate|skew)/i.test(t)
                ? "deg"
                : /(^(scale|scaleX|scaleY|scaleZ|alpha|flexGrow|flexHeight|zIndex|fontWeight)$)|((opacity|red|green|blue|alpha)$)/i.test(t)
                  ? ""
                  : "px"
            },
          ...
          getPropertyValue: function(t, i, a, o) {
            ...
            if (y.Hooks.registered[i]) {
              var u = i,
                h = y.Hooks.getRoot(u);
              a === n && (a = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])),
              y.Normalizations.registered[h] && (a = y.Normalizations.registered[h]("extract", t, a)),
              l = y.Hooks.extractValue(u, a)
            } else if (y.Normalizations.registered[i]) {
              var f,
                p;
              "transform" !== (f = y.Normalizations.registered[i]("name", t)) && (p = s(t, y.Names.prefixCheck(f)[0]), y.Values.isCSSNullValue(p) && y.Hooks.templates[i] && (p = y.Hooks.templates[i][1])),
          ...
          setPropertyValue: function(t, i, n, a, o) {
            ...
            if ("scroll" === i) 
            ...
            else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", t)) 
              ...
              if (y.Normalizations.registered[i] && (n = y.Normalizations.registered[i]("inject", t, n), i = y.Normalizations.registered[i]("name", t)), s = y.Names.prefixCheck(i)[0], 8 >= c) 
                try {
                  t.style[s] = n
                } catch (t) {
          ...
          flushTransformCache: function(t) {
            ...
            if ((c || v.State.isAndroid && !v.State.isChrome) && r(t).isSVG) {
              ...
              d.each(r(t).transformCache, function(e) {
                return a = r(t).transformCache[e],
                "transformPerspective" === e
                  ? (o = a, !0)
                  : (9 === c && "rotateZ" === e && (e = "rotate"), void(i += e + a + " "))
              }),
              o && (i = "perspective" + o + " " + i)
            }
        ...
        v.hook = function(t, e, i) {
          ...
          d.each(t, function(t, a) {
            if (r(a) === n && v.init(a), i === n) 
              ...
              "transform" === s[0] && v.CSS.flushTransformCache(a),
              o = s
            }
          }),
          o
        ...
        var x = function() {
          ...
          function o() {
            function t(t) {
              function h(t, e) {
                ...
                return f.isArray(t)
                  ? (
                    i = t[0], !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || y.RegEx.isHex.test(t[1])
                    ? r = t[1]
                    : (f.isString(t[1]) && !y.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (
                      a = e
                      ? t[1]
                      : s(t[1], u.duration),
                    t[2] !== n && (r = t[2])))
              ...
              function g() {
                ...
                if (a && n) 
                  ...
                  v.CSS.setPropertyValue(u, "position", t.position),
                  v.CSS.setPropertyValue(u, "fontSize", t.fontSize),
                  ...
                  l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(y.getPropertyValue(u, "width", null, !0)) || 1) / s,
                  l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(y.getPropertyValue(u, "height", null, !0)) || 1) / s,
                  l.emToPx = L.lastEmToPx = (parseFloat(y.getPropertyValue(u, "paddingLeft")) || 1) / s,
                  t.myParent.removeChild(u)
                }
                return null === L.remToPx && (L.remToPx = parseFloat(y.getPropertyValue(i.body, "fontSize")) || 16),
              ...
              if ("scroll" === P) {
                ...
                u.container
                  ? f.isWrapped(u.container) || f.isNode(u.container)
                    ? (u.container = u.container[0] || u.container, M = (x = u.container["scroll" + A]) + d(o).position()[A.toLowerCase()] + _)
                    : u.container = null
                  : (x = v.State.scrollAnchor[v.State["scrollProperty" + A]], k = v.State.scrollAnchor[v.State["scrollProperty" + (
                        "Left" === A
                        ? "Top"
                        : "Left")]], M = d(o).offset()[A.toLowerCase()] + _),
                c = {
                  scroll: {
                    rootPropertyValue: !1,
                    startValue: x,
                ...
                for (var D in I) 
                  if ("element" !== D) {
                    ...
                    I[D].endValue = F,
                    f.isEmptyObject(w) || (I[D].easing = u.easing),
                    v.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(I[D]), o)
                  }
                c = I
              } else if ("start" === P) {
                for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (I = r(o).tweensContainer), d.each(b, function(t, e) {
                  ...
                  if (r(o).isSVG || "tween" === W || !1 !== y.Names.prefixCheck(W)[1] || y.Normalizations.registered[W] !== n) {
                    (u.display !== n && null !== u.display && "none" !== u.display || u.visibility !== n && "hidden" !== u.visibility) && /opacity|filter/.test(O) && !E && 0 !== z && (E = 0),
                    u._cacheValues && I && I[O]
                      ? (E === n && (E = I[O].endValue + I[O].unitType), B = r(o).rootPropertyValueCache[W])
                      : y.Hooks.registered[O]
                        ? E === n
                          ? (B = y.getPropertyValue(o, W), E = y.getPropertyValue(o, O, B))
                          : B = y.Hooks.templates[W][1]
                        : E === n && (E = y.getPropertyValue(o, O));
                    var H,
                      j,
                      q,
                      Y = !1;
                    if (E = (H = p(O, E))[0], q = H[1], z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function(t, e) {
                      return Y = e,
                      ""
                    }), j = H[1], E = parseFloat(E) || 0, z = parseFloat(z) || 0, "%" === j && (
                      /^(fontSize|lineHeight)$/.test(O)
                      ? (z /= 100, j = "em")
                      : /^scale/.test(O)
                        ? (z /= 100, j = "")
                        : /(Red|Green|Blue)$/i.test(O) && (z = z / 100 * 255, j = "")), /[\/*]/.test(Y)) 
                      j = q;
                    else if (q !== j && 0 !== E) 
                      if (0 === z) 
                        j = q;
                        ...
                        a = a || g();
                        var U = /margin|padding|left|right|width|text|word|letter/i.test(O) || /X$/.test(O) || "x" === O
                          ? "x"
                          : "y";
                        switch (q) {
                          case "%":
              ...
              c.element && (
                y.Values.addClass(o, "velocity-animating"), R.push(c), "" === u.queue && (r(o).tweensContainer = c, r(o).opts = u), r(o).isAnimating = !0, C === S - 1
                ? (v.State.calls.push([R, m, u, null, T.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l()))
                : C++)
            }
            var a,
              o = this,
            ...
            !1 !== v.mock && (
              ...
              : (u.duration *= parseFloat(v.mock) || 1, u.delay *= parseFloat(v.mock) || 1)),
            u.easing = s(u.easing, u.duration),
            u.begin && !f.isFunction(u.begin) && (u.begin = null),
            u.progress && !f.isFunction(u.progress) && (u.progress = null),
            u.complete && !f.isFunction(u.complete) && (u.complete = null),
            u.display !== n && null !== u.display && (u.display = u.display.toString().toLowerCase(), "auto" === u.display && (u.display = v.CSS.Values.getDisplayType(o))),
            u.visibility !== n && null !== u.visibility && (u.visibility = u.visibility.toString().toLowerCase()),
            u.mobileHA = u.mobileHA && v.State.isMobile && !v.State.isGingerbread,
            !1 === u.queue
              ? u.delay
          ...
          m = a(m)) {
            k
              ? (b = arguments[0].properties || arguments[0].p, w = arguments[0].options || arguments[0].o)
            ...
            if (!/^(stop|finish)$/i.test(b) && !d.isPlainObject(w)) {
              ...
              for (var M = p + 1; M < arguments.length; M++) 
                f.isArray(arguments[M]) || !/^(fast|normal|slow)$/i.test(arguments[M]) && !/^\d/.test(arguments[M])
                ...
                return d.each(v.State.calls, function(t, e) {
                  e && d.each(e[1], function(i, a) {
                    ...
                    return !0 !== o && e[2].queue !== o && (w !== n || !1 !== e[2].queue) || void d.each(m, function(i, n) {
                      n === a && (
                        (!0 === w || f.isString(w)) && (d.each(d.queue(
                        n, f.isString(w)
                        ? w
                        : ""), function(t, e) {
                        f.isFunction(e) && e(null, !0)
                          ...
                          : "",
                        [])), "stop" === b
                        ? (r(n) && r(n).tweensContainer && !1 !== o && d.each(r(n).tweensContainer, function(t, e) {
                ...
                if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                  if (f.isString(b) && v.Redirects[b]) {
                    var _ = (O = d.extend({}, w)).duration,
                      I = O.delay || 0;
                    return !0 === O.backwards && (m = d.extend(!0, [], m).reverse()),
                    d.each(m, function(t, e) {
                      parseFloat(O.stagger)
                        ? O.delay = I + parseFloat(O.stagger) * t
                        : f.isFunction(O.stagger) && (O.delay = I + O.stagger.call(e, t, S)),
                      O.drag && (O.duration = parseFloat(_) || (
                        /^(callout|transition)/.test(b)
                        ? 1e3
                        : g), O.duration = Math.max(O.duration * (
                        O.backwards
                        ? 1 - t / S
                        : (t + 1) / S), .75 * O.duration, 200)),
                      v.Redirects[b].call(
                        e, e, O || {}, t, S, m, T.promise
                        ? T
                        : n)
                    }),
                    t()
            ...
            if (d.each(m, function(t, e) {
              ...
              for (var V = 0; F > V; V++) {
                ...
                V === F - 1 && (z.display = O.display, z.visibility = O.visibility, z.complete = O.complete),
                x(m, "reverse", z)
              }
            return t()
          }
        ...
        d.each([
          ...
          v.Redirects["slide" + e] = function(t, i, a, r, o, s) {
            ...
            l.display === n && (
              l.display = "Down" === e
              ? "inline" === v.CSS.Values.getDisplayType(t)
                ? "inline-block"
                : "block"
              : "none"),
            l.begin = function() {
      ...
      function(t, e, i) {
        ...
        r.prototype = {
          ...
          clone: function() {
            ...
            for (var o in n) 
              n.hasOwnProperty(o) && (
                t = n[o], "[object Array]" === (e = {}.toString.call(t))
                ? a[o] = t.slice(0)
                : "[object Number]" === e
                  ? a[o] = t
        ...
        r.prototype.setValues = function(t, e) {
          ...
          if (r.alpha = Math.max(0, Math.min(
            1, void 0 === l
            ? r.alpha
            : l)), "alpha" === t) 
            return !1;
      ...
      function(t, e, i) {
        ...
        function u(t) {
          ...
          return [
            100 * (.4124 * (
              e = e > .04045
              ? Math.pow((e + .055) / 1.055, 2.4)
              : e / 12.92) + .3576 * (
              i = i > .04045
              ? Math.pow((i + .055) / 1.055, 2.4)
              : i / 12.92) + .1805 * (
              n = n > .04045
              ? Math.pow((n + .055) / 1.055, 2.4)
              : n / 12.92)),
            100 * (.2126 * e + .7152 * i + .0722 * n),
            100 * (.0193 * e + .1192 * i + .9505 * n)
          ]
        }
        function d(t) {
          var e = u(t),
        ...
        function m(t) {
          var e,
            ...
            r = t[1] / 100,
            o = t[2] / 100;
          return i = -.9689 * a + 1.8758 * r + .0415 * o,
          n = .0557 * a + -.204 * r + 1.057 * o,
          e = (e = 3.2406 * a + -1.5372 * r + -.4986 * o) > .0031308
            ? 1.055 * Math.pow(e, 1 / 2.4) - .055
            : e *= 12.92,
          i = i > .0031308
            ? 1.055 * Math.pow(i, 1 / 2.4) - .055
            : i *= 12.92,
          n = n > .0031308
            ...
            updateElement: function(t, e, i) {
              ...
              t._model = {
                ...
                backgroundColor: l.backgroundColor
                  ? l.backgroundColor
                  : r.valueAtIndexOrDefault(s.backgroundColor, e, u.backgroundColor),
                borderColor: l.borderColor
                  ? l.borderColor
                  : r.valueAtIndexOrDefault(s.borderColor, e, u.borderColor),
                borderWidth: l.borderWidth
                  ? l.borderWidth
                  : r.valueAtIndexOrDefault(s.borderWidth, e, u.borderWidth)
              },
          ...
          t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
            ...
            updateElement: function(t, e, i) {
              ...
              b.backgroundColor = y.backgroundColor
                ? y.backgroundColor
                : x(f.backgroundColor, e, w.backgroundColor),
              b.borderColor = y.borderColor
                ? y.borderColor
                : x(f.borderColor, e, w.borderColor),
              b.borderWidth = y.borderWidth
                ? y.borderWidth
                : x(f.borderWidth, e, w.borderWidth),
              i && l.animateRotate || (
                b.startAngle = 0 === e
                ? s.rotation
          ...
          t.controllers.line = t.DatasetController.extend({
            ...
            update: function(t) {
              ...
              for (p && (a = l.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), l._scale = h, l._datasetIndex = o.index, l._children = u, l._model = {
                ...
                cubicInterpolationMode: a.cubicInterpolationMode
                  ...
                  : r.valueOrDefault(f.cubicInterpolationMode, c.cubicInterpolationMode)
            ...
            getPointBackgroundColor: function(t, e) {
              ...
              return a.backgroundColor
                ...
                : n.pointBackgroundColor
                  ? i = r.valueAtIndexOrDefault(n.pointBackgroundColor, e, i)
            ...
            getPointRotation: function(t, e) {
              var i = this.chart.options.elements.point.rotation,
                n = this.getDataset(),
                a = t.custom || {};
              return isNaN(a.rotation)
                ? isNaN(n.pointRotation) && !r.isArray(n.pointRotation) || (i = r.valueAtIndexOrDefault(n.pointRotation, e, i))
                : i = a.rotation,
              i
            },
            updateElement: function(t, e, i) {
            ...
            draw: function() {
              ...
              for (e(this.getDataset(), i.options) && (t = (n.dataset._model.borderWidth || 0) / 2, r.canvas.clipArea(i.ctx, {
                ...
                top: o.top - t,
                bottom: o.bottom + t
              }), n.dataset.draw(), r.canvas.unclipArea(i.ctx)); l < s; ++l) 
                a[l].draw(o)
            },
            setHoverStyle: function(t) {
          ...
          t.controllers.polarArea = t.DatasetController.extend({
            ...
            update: function(t) {
              var e,
                ...
                u = a._starts = [],
                d = a._angles = [];
              for (a._updateRadius(), s.count = a.countVisibleElements(), e = 0, i = o.data.length; e < i; e++) 
                u[e] = l,
                n = a._computeAngle(e),
                d[e] = n,
                l += n;
          ...
          t.controllers.radar = t.DatasetController.extend({
            ...
            updateElement: function(t, e, i) {
              ...
              r.extend(t, {
                ...
                _model: {
                  ...
                  tension: a.tension
                    ? a.tension
                    : r.valueOrDefault(o.lineTension, n.chart.options.elements.line.tension),
                  radius: a.radius
                    ? a.radius
                    : r.valueAtIndexOrDefault(o.pointRadius, e, l.radius),
                  backgroundColor: a.backgroundColor
                    ? a.backgroundColor
                    : r.valueAtIndexOrDefault(o.pointBackgroundColor, e, l.backgroundColor),
                  borderColor: a.borderColor
                    ? a.borderColor
                    : r.valueAtIndexOrDefault(o.pointBorderColor, e, l.borderColor),
                  borderWidth: a.borderWidth
                    ? a.borderWidth
                    : r.valueAtIndexOrDefault(o.pointBorderWidth, e, l.borderWidth),
                  pointStyle: a.pointStyle
                    ? a.pointStyle
                    : r.valueAtIndexOrDefault(o.pointStyle, e, l.pointStyle),
                  rotation: a.rotation
                    ? a.rotation
                    : r.valueAtIndexOrDefault(o.pointRotation, e, l.rotation),
                  hitRadius: a.hitRadius
                    ? a.hitRadius
                    : r.valueAtIndexOrDefault(o.pointHitRadius, e, l.hitRadius)
                }
              }),
            ...
            setHoverStyle: function(t) {
              ...
              a.radius = i.hoverRadius
                ? i.hoverRadius
                : r.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius),
              a.backgroundColor = i.hoverBackgroundColor
                ? i.hoverBackgroundColor
                : r.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, r.getHoverColor(a.backgroundColor)),
              a.borderColor = i.hoverBorderColor
                ? i.hoverBorderColor
                : r.valueAtIndexOrDefault(e.pointHoverBorderColor, n, r.getHoverColor(a.borderColor)),
              a.borderWidth = i.hoverBorderWidth
                ? i.hoverBorderWidth
                : r.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth)
            }
          })
        }
      }, {
    ...
    23: [
      function(t, e, i) {
        ...
        e.exports = {
          ...
          advance: function(t) {
            for (var e, i, n = this.animations, r = 0; r < n.length;) 
              i = (e = n[r]).chart,
              ...
              e.currentStep >= e.numSteps
                ? (a.callback(e.onAnimationComplete, [e], i), i.animating = !1, n.splice(r, 1))
                : ++r
            }
        }
      }, {
          ...
          o.extend(t.prototype, {
            construct: function(e, i) {
              ...
              i = function(t) {
                ...
                e.labels = e.labels || [],
                t.options = o.configMerge(r.global, r[t.type], t.options || {}),
                t
              }(i);
            ...
            resize: function(t) {
              ...
              if ((e.width !== r || e.height !== s) && (n.width = e.width = r, n.height = e.height = s, n.style.width = r + "px", n.style.height = s + "px", o.retinaScale(e, i.devicePixelRatio), !t)) {
                ...
                e.stop(),
                e.update({duration: e.options.responsiveAnimationDuration})
              }
            },
            ...
            buildOrUpdateScales: function() {
              ...
              o.each(a, function(i) {
                ...
                e(a.position) !== e(i.dposition) && (a.position = i.dposition),
                r[s] = !0;
                var u = null;
                if (s in n && n[s].type === l) 
                  ...
                  if (!d) 
                    return;
                  u = new d({id: s, type: l, options: a, ctx: t.ctx, chart: t}),
                  n[u.id] = u
                }
                u.mergeTicksOptions(),
                i.isDefault && (t.scale = u)
              }),
            ...
            update: function(e) {
              ...
              if (e && "object" == typeof e || (e = {
                ...
                a.updateLayout(),
                a.options.animation && a.options.animation.duration && o.each(r, function(t) {
                  t.reset()
                }),
                a.updateDatasets(),
                a.tooltip.initialize(),
                a.lastActive = [],
                d.notify(a, "afterUpdate"),
                a._bufferedRender
                  ? a._bufferedRequest = {
                    duration: e.duration,
                    easing: e.easing,
            ...
            render: function(t) {
              ...
              if (!1 !== d.notify(e, "beforeRender")) {
                var s = e.options.animation,
                  l = function(t) {
                    d.notify(e, "afterRender"),
                    o.callback(s && s.onComplete, [t], e)
                  };
            ...
            draw: function(t) {
              ...
              e.transition(t),
              e.width <= 0 || e.height <= 0 || !1 !== d.notify(e, "beforeDraw", [t]) && (o.each(e.boxes, function(t) {
                t.draw(e.chartArea)
            ...
            destroy: function() {
              ...
              a && (n.unbindEvents(), o.canvas.clear(n), u.releaseContext(n.ctx), n.canvas = null, n.ctx = null),
              d.notify(n, "destroy"),
            ...
            eventHandler: function(t) {
              ...
              if (!1 !== d.notify(e, "beforeEvent", [t])) {
                ...
                i && (
                  ...
                  ? i.handleEvent(t)
                  : n | i.handleEvent(t)),
                d.notify(e, "afterEvent", [t]);
                var a = e._bufferedRequest;
                return a
                  ? e.render(a)
                  : n && !e.animating && (e.stop(), e.render({
            ...
            handleEvent: function(t) {
              ...
              o.callback(n.onHover || n.hover.onHover, [
                t.native, i.active
              ], i),
          ...
          n.extend(t.DatasetController.prototype, {
            ...
            buildOrUpdateElements: function() {
              var t,
                ...
                s = o.data || (o.data = []);
              r._data !== s && (
                r._data && i(r._data, r), a = r, (t = s)._chartjs
        ...
        a.extend(r.prototype, {
          ...
          transition: function(t) {
            var e = this,
              ...
              r = e._view;
            return i && 1 !== t
              ? (r || (r = e._view = {}), a || (a = e._start = {}), function(t, e, i, a) {
                var r,
                  o,
                  s,
                  l,
    ...
    28: [
      function(t, e, i) {
        ...
        e.exports = function() {
            ...
            return r.merge(r.clone(arguments[0]), [].slice.call(arguments, 1), {
              merger: function(t, e, i, n) {
                var a = e[t] || {},
                  s = i[t];
                "scales" === t
                  ? e[t] = r.scaleMerge(a, s)
                  : "scale" === t
                    ? e[t] = r.merge(a, [
                      o.getScaleDefaults(s.type),
                      s
                    ])
                    : r._merger(t, e, i, n)
              }
              ...
              merger: function(t, e, i, n) {
                if ("xAxes" === t || "yAxes" === t) {
                  ...
                  for (e[t] || (e[t] = []), a = 0; a < u; ++a) 
                    ...
                    !e[t][a].type || l.type && l.type !== e[t][a].type
                      ? r.merge(e[t][a], [o.getScaleDefaults(s), l])
                      : r.merge(e[t][a], l)
                  } else 
                  r._merger(t, e, i, n)
              }
          ...
          r.requestAnimFrame = "undefined" == typeof window
            ? function(t) {
              t()
            }
          ...
          r._calculatePadding = function(t, e, i) {
            return (e = r.getStyle(t, e)).indexOf("%") > -1
              ? i / parseInt(e, 10)
              : parseInt(e, 10)
          },
          ...
          r.longestText = function(t, e, i, n) {
            ...
            n.font !== e && (a = n.data = {}, o = n.garbageCollect = [], n.font = e),
            t.font = e;
            var s = 0;
            r.each(i, function(e) {
              void 0 !== e && null !== e && !0 !== r.isArray(e)
                ? s = r.measureText(t, a, o, s, e)
                : r.isArray(e) && r.each(e, function(e) {
          ...
          r.measureText = function(t, e, i, n, a) {
            var r = e[a];
            return r || (r = e[a] = t.measureText(a).width, i.push(a)),
            r > n && (n = r),
            n
          },
          ...
          r.getHoverColor = function(t) {
            return t instanceof CanvasPattern
              ? t
              : r.color(t).saturate(.5).darken(.1).rgbString()
          }
        }
      }, {
        26: 26,
          ...
          update: function(t, e, i) {
            ...
            function W(t) {
              t.isHorizontal()
                ...
                t.bottom = N + t.height,
                N = t.bottom)
                : (t.left = z, t.right = z + t.width, t.top = D, t.bottom = D + S, z = t.right)
            }
          }
        }
      }, {
        ...
        e.exports = {
          ...
          notify: function(t, e, i) {
            var n,
              ...
              u = l.length;
            for (n = 0; n < u; ++n) 
              if ("function" == typeof(s = (r = (a = l[n]).plugin)[e]) && ((o = [t].concat(i || [])).push(a.options), !1 === s.apply(r, o))) 
                return !1;
          return !0
          },
        ...
        e.exports = a.extend({
          ...
          fit: function() {
            ...
            if (a.display && h) {
              ...
              if (f) {
                ...
                e.height = Math.min(t.maxHeight, e.height + S + x),
                t.ctx.font = p.font;
                var C = u(t.ctx, i[0], p.font),
                  M = u(t.ctx, i[i.length - 1], p.font);
                0 !== t.labelRotation
                  ? (
                    t.paddingLeft = "bottom" === n.position
                    ? k * C + 3
                    : k * y + 3,
                  t.paddingRight = "bottom" === n.position
                    ? k * y + 3
                    : k * M + 3)
                  : (t.paddingLeft = C / 2 + 3, t.paddingRight = M / 2 + 3)
              } else 
                a.mirror
                  ? v = 0
                  : v += x + y,
                e.width = Math.min(t.maxWidth, e.width + v),
          ...
          getPixelForTick: function(t) {
            var e = this,
              i = e.options.offset;
            if (e.isHorizontal()) {
              var n = (e.width - (e.paddingLeft + e.paddingRight)) / Math.max(e._ticks.length - (
                  i
                  ? 0
                  : 1), 1),
                a = n * t + e.paddingLeft;
              ...
              if (r.each(m, function(n, a) {
                if (!r.isNullOrUndef(n.label)) {
                  var u,
                    ...
                    L,
                    R = n.label;
                  a === e.zeroLineIndex && i.offset === h.offsetGridLines
                    ? (u = h.zeroLineWidth, d = h.zeroLineColor, c = h.zeroLineBorderDash, f = h.zeroLineBorderDashOffset)
                    : (u = r.valueAtIndexOrDefault(h.lineWidth, a), d = r.valueAtIndexOrDefault(h.color, a), c = r.valueOrDefault(h.borderDash, o.borderDash), f = r.valueOrDefault(h.borderDashOffset, o.borderDashOffset));
                  var V = "middle",
                    z = "middle",
                    N = s.padding;
                  if (g) {
                    ...
                    W < e.left && (d = "rgba(0,0,0,0)"),
                    W += r.aliasPixel(u),
                    O = e.getPixelForTick(a) + s.labelOffset,
                    v = y = k = C = W,
                    b = I,
                    x = D,
                    S = t.top,
                    ...
                    j < e.top && (d = "rgba(0,0,0,0)"),
                    j += r.aliasPixel(u),
                    L = e.getPixelForTick(a) + s.labelOffset,
                    v = A,
                    y = _,
                    k = t.left,
                    C = t.right + T,
                ...
                if (h.display && (a.save(), a.lineWidth = t.glWidth, a.strokeStyle = t.glColor, a.setLineDash && (a.setLineDash(t.glBorderDash), a.lineDashOffset = t.glBorderDashOffset), a.beginPath(), h.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)), a.stroke(), a.restore()), s.display) {
                  ...
                  if (r.isArray(i)) 
                    for (
                      var n = i.length, o = 1.5 * b.size, l = e.isHorizontal()
                      ? 0
                      : -o * (n - 1) / 2,
                    u = 0; u < n; ++u) 
                      a.fillText("" + i[u], 0, l),
                ...
                a.fillStyle = k,
                a.font = S.font,
                a.fillText(f.labelString, 0, 0),
                a.restore()
              }
              if (h.drawBorder) {
                a.lineWidth = r.valueAtIndexOrDefault(h.lineWidth, 0),
                a.strokeStyle = r.valueAtIndexOrDefault(h.color, 0);
                var z = e.left,
                  N = e.right + T,
                  E = e.top,
                  W = e.bottom + T,
        ...
        function c(t) {
          ...
          getBody: function(t, e) {
            ...
            return r.each(t, function(t) {
              ...
              l(r.before, u(n.beforeLabel.call(i, t, e))),
              l(r.lines, n.label.call(i, t, e)),
              l(r.after, u(n.afterLabel.call(i, t, e))),
              a.push(r)
            }),
            a
          },
          ...
          update: function(t) {
            ...
            if (g.length) {
              ...
              for (e = 0, i = g.length; e < i; ++e) 
                S.push((n = g[e], a = void 0, s = void 0, void 0, void 0, a = n._xScale, s = n._yScale || n._scale, l = n._index, u = n._datasetIndex, {
                  xLabel: a
                    ? a.getLabelForIndex(l, u)
                    : "",
                  yLabel: s
                    ? s.getLabelForIndex(l, u)
                    : "",
                  index: l,
                  datasetIndex: u,
                  x: n._model.x,
              ...
              r.each(S, function(t) {
                ...
                k.push(h.callbacks.labelTextColor.call(c, t, c._chart))
              }),
              p.title = c.getTitle(S, m),
              p.beforeBody = c.getBeforeBody(S, m),
              p.body = c.getBody(S, m),
              p.afterBody = c.getAfterBody(S, m),
              p.footer = c.getFooter(S, m),
              p.x = Math.round(x.x),
              p.y = Math.round(x.y),
              ...
              b = function(t, e, i, n) {
                ...
                return "right" === u
                  ? a -= e.width
                  : "center" === u && ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width), a < 0 && (a = 0)),
                "top" === d
                  ? r += c
                  : r -= "bottom" === d
                    ? e.height + c
                ...
                return i.font = r.fontString(d, e._titleFontStyle, e._titleFontFamily),
                r.each(e.title, p),
                i.font = r.fontString(c, e._bodyFontStyle, e._bodyFontFamily),
                ...
                f = 0,
                i.font = r.fontString(h, e._footerFontStyle, e._footerFontFamily),
                r.each(e.footer, p), {
          ...
          drawTitle: function(t, e, i, n) {
            ...
            if (a.length) {
              ...
              var o,
                ...
                u = e.titleFontSize,
                d = e.titleSpacing;
              for (i.fillStyle = s(e.titleFontColor, n), i.font = r.fontString(u, e._titleFontStyle, e._titleFontFamily), o = 0, l = a.length; o < l; ++o) 
                i.fillText(a[o], t.x, t.y),
                t.y += u + d,
                o + 1 === a.length && (t.y += e.titleMarginBottom - d)
            }
          },
          drawBody: function(t, e, i, n) {
            ...
            i.textBaseline = "top",
            i.font = r.fontString(a, e._bodyFontStyle, e._bodyFontFamily);
            var u = 0,
              d = function(e) {
                i.fillText(e, t.x + u, t.y),
                t.y += a + o
              };
            i.fillStyle = s(e.bodyFontColor, n),
            r.each(e.beforeBody, d);
            var c = e.displayColors;
            u = c
              ? a + 2
              : 0,
            r.each(l, function(o, l) {
              var u = s(e.labelTextColors[l], n);
              i.fillStyle = u,
              r.each(o.before, d),
              r.each(o.lines, function(r) {
                c && (i.fillStyle = s(e.legendColorBackground, n), i.fillRect(t.x, t.y, a, a), i.lineWidth = 1, i.strokeStyle = s(e.labelColors[l].borderColor, n), i.strokeRect(t.x, t.y, a, a), i.fillStyle = s(e.labelColors[l].backgroundColor, n), i.fillRect(t.x + 1, t.y + 1, a - 2, a - 2), i.fillStyle = u),
                d(r)
              }),
              r.each(o.after, d)
            }),
            u = 0,
            r.each(e.afterBody, d),
            t.y -= o
          },
          ...
          drawBackground: function(t, e, i, n, a) {
            i.fillStyle = s(e.backgroundColor, a),
            i.strokeStyle = s(e.borderColor, a),
          ...
          handleEvent: function(t) {
            ...
            (e = !r.arrayEquals(i._active, i._lastActive)) && (i._lastActive = i._active, (n.enabled || n.custom) && (i._eventPosition = {
              x: t.x,
              y: t.y
            }, i.update(!0), i.pivot())),
            e
        ...
        e.exports = a.extend({
          draw: function() {
            ...
            if (
              l.horizontal
              ? (
                t = l.base, e = l.x, i = l.y - l.height / 2, n = l.y + l.height / 2, a = e > t
                ? 1
                : -1,
              r = 1,
              o = l.borderSkipped || "left")
              : (
                t = l.x - l.width / 2, e = l.x + l.width / 2, i = l.y, a = 1, r = (n = l.base) > i
                ? 1
                : -1,
        ...
        i = e.exports = {
          ...
          roundedRect: function(t, e, i, n, a, r) {
            if (r) {
              ...
              t.moveTo(e + o, i),
              t.lineTo(e + n - o, i),
              t.arcTo(e + n, i, e + n, i + o, o),
              t.lineTo(e + n, i + a - o),
              t.arcTo(e + n, i + a, e + n - o, i + a, o),
              t.lineTo(e + o, i + a),
              t.arcTo(e, i + a, e, i + a - o, o),
              t.lineTo(e, i + o),
              t.arcTo(e, i, e + o, i, o),
              t.closePath(),
              t.moveTo(e, i)
          ...
          lineTo: function(t, e, i, n) {
            if (i.steppedLine) 
              return "after" === i.steppedLine && !n || "after" !== i.steppedLine && n
                ? t.lineTo(e.x, i.y)
                : t.lineTo(i.x, e.y),
        ...
        var n = t(43),
          a = {
              ...
              return 0 === t
                ...
                : 1 === t
                  ...
                  : (
                    i || (i = .3), n < 1
                    ? (n = 1, e = i / 4)
                    : e = i / (2 * Math.PI) * Math.asin(1 / n), -n * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / i))
            },
              ...
              return 0 === t
                ...
                : 2 == (t /= .5)
                  ...
                  : (
                    ...
                    : e = i / (2 * Math.PI) * Math.asin(1 / n),
                  t < 1
                    ? n * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / i) * -.5
                    : n * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / i) * .5 + 1)
            },
            ...
            easeInOutBounce: function(t) {
              return t < .5
                ? .5 * a.easeInBounce(2 * t)
                : .5 * a.easeOutBounce(2 * t - 1) + .5
            }
          };
        e.exports = {
          effects: a
        ...
        e.exports = {
          ...
          toPadding: function(t) {
            var e,
              ...
              r;
            return n.isObject(t)
              ? (e = + t.top || 0, i = + t.right || 0, a = + t.bottom || 0, r = + t.left || 0)
              : e = i = a = r = + t || 0, {
              top: e,
              right: i,
              bottom: a,
          ...
          resolve: function(t, e, i) {
            var a,
              ...
              o;
            for (a = 0, r = t.length; a < r; ++a) 
              if (void 0 !== (o = t[a]) && (void 0 !== e && "function" == typeof o && (o = o(e)), void 0 !== i && n.isArray(o) && (o = o[i]), void 0 !== o)) 
                return o
          }
        }
      }, {
      ...
      function(t, e, i) {
        ...
        function g(t, e, i) {
          var u,
            ...
            m = g.resizer = function(t) {
              ...
              d = d || this,
              c || (c = !0, n.requestAnimFrame.call(window, function() {
                c = !1,
                u.apply(d, f)
              }))
            }));
          !function(t, e) {
            ...
            if (g.resizer) {
              var e = t.parentNode;
              e && e !== m.parentNode && e.insertBefore(m, e.firstChild),
              m._reset()
            }
          })
        }
        ...
        e.exports = {
          ...
          initialize: function() {
            ...
            e = "@-webkit-keyframes " + s + "{" + n + "}@keyframes " + s + "{" + n + "}." + o + "{-webkit-animation:" + s + " 0.001s;animation:" + s + " 0.001s;}",
      ...
      function(t, e, i) {
        ...
        e.exports = {
          ...
          afterDatasetsUpdate: function(t, e) {
            ...
            for (n = 0; n < c; ++n) 
              o = null,
              (r = (i = t.getDatasetMeta(n)).dataset) && r._model && r instanceof a.Line && (o = {
            ...
            if (i) {
              ...
              u && d && l.length && (r.canvas.clipArea(a, t.chartArea), function(t, e, i, n, a, r) {
                ...
                for (t.beginPath(), o = 0, s = g + !!r; o < s; ++o) 
                  ...
                  p = c(d),
                  f && p
                    ? (y = v.push(u), x = b.push(d))
                    : y && x && (
                      m
                      ? (f && v.push(u), p && b.push(d))
                      : (h(t, v, b, y, x), y = x = 0, v = [], b = []));
                h(t, v, b, y, x),
                t.closePath(),
                t.fillStyle = a,
                t.fill()
          ...
          fit: function() {
            ...
            if (
              ...
              : (
                ...
                ? 10
                : 0,
              g.height = t.maxHeight),
            a) 
              if (o.font = f, m) {
                var v = t.lineWidths = [0],
                  b = t.legendItems.length
                    ? d + i.padding
                    : 0;
                o.textAlign = "left",
                o.textBaseline = "top",
              ...
              r.each(t.legendItems, function(t, e) {
                ...
                S + C > g.height && (w += k + i.padding, x.push(k), k = 0, S = 0),
                k = Math.max(k, n),
                S += C,
                p[e] = {
                  left: 0,
            ...
            if (e.display) {
              ...
              r.each(t.legendItems, function(n, l) {
                var f = c.measureText(n.text).width,
                  ...
                  v = d.y;
                x
                  ? m + g >= s && (v = d.y += w, d.line++, m = d.x = t.left + (s - u[d.line]) / 2)
                  : v + w > t.bottom && (m = d.x = m + t.columnWidths[d.line] + i.padding, v = d.y = t.top + i.padding, d.line++),
                function(t, i, n) {
                  if (!(isNaN(b) || b <= 0)) {
                    c.save(),
                    c.fillStyle = h(n.fillStyle, a.defaultColor),
                    c.lineCap = h(n.lineCap, o.borderCapStyle),
                    c.lineDashOffset = h(n.lineDashOffset, o.borderDashOffset),
                ...
                function(t, e, i, n) {
                  ...
                  i.hidden && (c.beginPath(), c.lineWidth = 2, c.moveTo(r, o), c.lineTo(r + n, o), c.stroke())
                }(m, v, n, f),
                x
                  ? d.x += g + i.padding
                  : d.y += w
          ...
          var t = n.extend({
            ...
            determineDataLimits: function() {
              ...
              void 0 !== e.options.ticks.min && (
                t = i.indexOf(e.options.ticks.min), e.minIndex = -1 !== t
                ? t
                : e.minIndex),
              void 0 !== e.options.ticks.max && (
                t = i.indexOf(e.options.ticks.max), e.maxIndex = -1 !== t
                ? t
                : e.maxIndex),
              e.min = i[e.minIndex],
              e.max = i[e.maxIndex]
            ...
            buildTicks: function() {
              var t = this,
                e = t.getLabels();
              t.ticks = 0 === t.minIndex && t.maxIndex === e.length - 1
                ? e
            ...
            getPixelForValue: function(t, e) {
              var i,
                n = this,
                a = n.options.offset,
                r = Math.max(n.maxIndex + 1 - n.minIndex - (
                  a
                  ? 0
                  : 1), 1);
              if (void 0 !== t && null !== t && (
          ...
          var e = {
            ...
            i = t.LinearScaleBase.extend({
              determineDataLimits: function() {
                ...
                if (void 0 === s && a.each(n, function(t, e) {
                  ...
                  a.each(n, function(n, r) {
                    var s = i.getDatasetMeta(r),
                      u = [
                        s.type, void 0 === e.stacked && void 0 === s.stack
                          ? r
                          : "",
                        s.stack
                      ].join(".");
                    ...
                    i.isDatasetVisible(r) && o(s) && a.each(n.data, function(i, n) {
                      ...
                      isNaN(a) || s.data[n].hidden || (
                        d[n] = d[n] || 0, c[n] = c[n] || 0, e.relativePoints
                        ? d[n] = 100
                        : a < 0
                          ? c[n] += a
                          : d[n] += a)
                ...
                t.min = isFinite(t.min) && !isNaN(t.min)
                  ? t.min
                  : 0,
                t.max = isFinite(t.max) && !isNaN(t.max)
                  ? t.max
                  : 1,
        ...
        e.exports = function(t) {
          ...
          t.LinearScaleBase = a.extend({
            getRightValue: function(t) {
              return "string" == typeof t
                ? + t
                : a.prototype.getRightValue.call(this, t)
            },
              ...
              var t = this,
                ...
                r = t.ticks = function(t, e) {
                  ...
                  if (t.stepSize && t.stepSize > 0) 
                    ...
                    r = n.niceNum(s / (t.maxTicks - 1), !0),
                    void 0 !== (a = t.precision) && (i = Math.pow(10, a), r = Math.ceil(r * i) / i)
                  }
                  ...
                  var d = (u - l) / r;
                  d = n.almostEquals(d, Math.round(d), r / 1e3)
                    ? Math.round(d)
                    : Math.ceil(d),
                  a = 1,
                  r < 1 && (a = Math.pow(10, 1 - Math.floor(n.log10(r))), l = Math.round(l * a) / a, u = Math.round(u * a) / a),
                  o.push(
                    void 0 !== t.min
                    ? t.min
                    : l);
                  for (var c = 1; c < d; ++c) 
                    o.push(Math.round((l + c * r) * a) / a);
                  return o.push(
                    void 0 !== t.max
                    ? t.max
                    : u),
            ...
            convertTicksToLabels: function() {
              ...
              a.prototype.convertTicksToLabels.call(t)
            }
          })
        }
      }, {
          ...
          var e = {
            ...
            i = a.extend({
              ...
              handleTickRangeOptions: function() {
                ...
                t.min === t.max && (
                  0 !== t.min && null !== t.min
                  ? (t.min = Math.pow(10, Math.floor(n.log10(t.min)) - 1), t.max = Math.pow(10, Math.floor(n.log10(t.max)) + 1))
                  : (t.min = 1, t.max = 10)),
              ...
              convertTicksToLabels: function() {
                ...
                a.prototype.convertTicksToLabels.call(this)
              },
              getLabelForIndex: function(t, e) {
                return + this.getRightValue(this.chart.data.datasets[e].data[t])
              },
              ...
              getPixelForValue: function(e) {
                ...
                l.isHorizontal()
                  ...
                  : (
                    ...
                    ? l.top
                    : l.bottom),
                e !== r && (0 === r && (i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize), r = c), 0 !== e && (h += i / (d(o) - d(r)) * (d(e) - d(r))), a += s * h),
                a
              },
        ...
        e.exports = function(t) {
          ...
          var p = t.LinearScaleBase.extend({
            ...
            determineDataLimits: function() {
              ...
              t.min = i === Number.POSITIVE_INFINITY
                ? 0
                : i,
              t.max = n === Number.NEGATIVE_INFINITY
                ? 0
                : n,
              ...
              this.options.pointLabels.display
                ? function(t) {
                  ...
                  for (e = 0; e < g; e++) {
                    ...
                    y.start < d.t && (d.t = y.start, c.t = m),
                    y.end > d.b && (d.b = y.end, c.b = m)
                  }
            ...
            setReductions: function(t, e, i) {
              ...
              r = f(r),
              o = f(o),
              this.drawingArea = Math.min(Math.round(t - (n + a) / 2), Math.round(t - (r + o) / 2)),
                  ...
                  if (l > 0 || r.reverse) {
                    ...
                    if (n.display && 0 !== l && function(t, e, i, n) {
                      ...
                      if (u.font = v, u.save(), u.translate(t.xCenter, t.yCenter), u.rotate(f), r.showLabelBackdrop) {
                        ...
                        u.fillStyle = r.backdropColor,
                        u.fillRect(-h / 2 - r.backdropPaddingX, -d - p / 2 - r.backdropPaddingY, h + 2 * r.backdropPaddingX, p + 2 * r.backdropPaddingY)
                      }
                      u.textAlign = "center",
                  ...
                  for (var p = s(t) - 1; p >= 0; p--) {
                    ...
                    if (o.display) {
                      ...
                      var b = t.getIndexAngle(p),
                        y = a.toDegrees(b);
                      i.textAlign = d(y),
                      h(y, t._pointLabelSizes[p], m),
                      c(i, t.pointLabels[p] || "", m, f.size)
                    }
                  }
                }(t)
              }
      ...
      function(t, e, i) {
        ...
        function g(t, e) {
          ...
          return "function" == typeof i
            ...
            : "string" == typeof t && "string" == typeof a
              ? n(t, a)
              : (
                t instanceof n || (t = n(t)), t.isValid()
                ? t
                : "function" == typeof a
                  ? a(t)
                  : t)
        ...
        function b(t, e, i, a) {
          ...
          for (f || (f = function(t, e, i, n) {
            ...
            ;
            return o
          }(t, e, l, i)), p && (b = b.isoWeekday(p), y = y.isoWeekday(p)), b = b.startOf(
            p
            ? "day"
            : l), (y = y.startOf(
            p
            ? "day"
            : l)) < e && y.add(1, l), o = n(b), g && h && !p && !s.round && (o.startOf(h), o.add(~~ ((b - o) / (m.size * f)) * f, l)); o < y; o.add(f, l)) 
            x.push(+ o);
          return x.push(+ o),
          x
        }
          ...
          var t = o.extend({
            ...
            determineDataLimits: function() {
              ...
              for (t = 0, i = (c.data.datasets || []).length; t < i; ++t) 
                ...
                x[t] = [];
              w.length && (w = f(w).sort(h), v = Math.min(v, w[0]), b = Math.max(b, w[w.length - 1])),
              y.length && (y = f(y).sort(h), v = Math.min(v, y[0]), b = Math.max(b, y[y.length - 1])),
              v = m(p.min, d) || v,
              b = m(p.max, d) || b,
              v = v === u
                ? + n().startOf(g)
              ...
              b = b === l
                ...
                : b,
              d.min = Math.min(v, b),
              d.max = Math.max(v + 1, b),
              d._horizontal = d.isHorizontal(),
              d._table = [],
              d._timestamps = {
                data: y,
                datasets: x,
            ...
            buildTicks: function() {
              ...
              for ("ticks" === s.bounds && u.length && (r = u[0], o = u[u.length - 1]), r = m(l.min, a) || r, o = m(l.max, a) || o, t = 0, e = u.length; t < e; ++t) 
                (i = u[t]) >= r && i <= o && h.push(i);
              return a.min = r,
              a.max = o,
              a._unit = l.unit || function(t, e, i, a) {
                var r,
                  o,
                  s = n.duration(n(a).diff(n(i)));
                for (r = c.length - 1; r >= c.indexOf(e); r--) 
                  if (o = c[r], d[o].common && s.as(o) >= t.length) 
                    return o;
              return c[
                  e
                    ? c.indexOf(e)
              ...
              }(h, l.minUnit, a.min, a.max),
              a._majorUnit = v(a._unit),
              ...
              a._offsets = function(t, e, i, n, a) {
                var r,
                  ...
                  s = 0,
                  l = 0;
                return a.offset && e.length && (a.time.min || (
                  r = e.length > 1
                  ? e[1]
                  : n,
                o = e[0],
                s = (p(t, "time", r, "pos") - p(t, "time", o, "pos")) / 2), a.time.max || (
                  r = e[e.length - 1], o = e.length > 1
                  ? e[e.length - 2]
                  : i,
                l = (p(t, "time", r, "pos") - p(t, "time", o, "pos")) / 2)), {
                  left: s,
                  right: l
                }
              }(a._table, h, r, o, s),
            ...
            getLabelForIndex: function(t, e) {
              var i = this.chart.data,
                n = this.options.time,
                a = i.labels && t < i.labels.length
                  ? i.labels[t]
                  : "",
                o = i.datasets[e].data[t];
              return r.isObject(o) && (a = this.getRightValue(o)),
              n.tooltipFormat
                ? g(a, n).format(n.tooltipFormat)
                : "string" == typeof a
                  ? a
                  : g(a, n).format(this._labelFormat)
            },
            ...
            getPixelForValue: function(t, e, i) {
              var n = null;
              if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = m(t, this)), null !== n) 
            ...
            getValueForPixel: function(t) {
              var e = this,
                ...
                r = (
                  i
                  ? (t - a) / i
                  : 0) * (e._offsets.left + 1 + e._offsets.left) - e._offsets.right,
      ...
      init: function() {
        ...
        t(window).scroll(function() {
          var e,
            r;
          i
            ? (e = window.innerHeight, r = window.scrollY, t(".wow.animated").each(function() {
              if (e + r - 100 > a(this) && r > a(this) + 100 || e + r - 100 < a(this) && r < a(this) + 100 || a(this) + t(this).height > t(document).height() - 100) 
        ...
        t(".wow").each(function() {
          ...
          n
            ? (n = t(this).attr("data-wow-delay").slice(0, -1), parseFloat(n), t(this).addClass("animated"), t(this).css({visibility: "visible"}), t(this).css({
              "animation-delay": n + "s"
...
function() {
  ...
  function r(t) {
    ...
    return "[object String]" === r
      ? e(t)
      : a(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(r) && t.hasOwnProperty("length")
        ? t
        : a(n = t) && n.nodeType > 0
          ? [t]
          : []
  ...
  var l = {
      ...
      show: function(t, e, i) {
        ...
        "touches" in t && t.touches.length
          ...
          : (r = t.pageY - a.top, u = t.pageX - a.left),
        u = u >= 0
          ? u
          : 0,
        r = r >= 0
        ...
        var d = "scale(" + e.clientWidth / 100 * 3 + ")",
          c = "translate(0,0)";
        i && (c = "translate(" + i.x + "px, " + i.y + "px)"),
        n.setAttribute("data-hold", Date.now()),
        n.setAttribute("data-x", u),
        n.setAttribute("data-y", r),
        n.setAttribute("data-scale", d),
        ...
        h["-webkit-transform"] = d + " " + c,
        h["-moz-transform"] = d + " " + c,
        h["-ms-transform"] = d + " " + c,
        h["-o-transform"] = d + " " + c,
        h.transform = d + " " + c,
        h.opacity = "1";
        var f = "mousemove" === t.type
          ? 2500
          : l.duration;
      ...
      hide: function(t, e) {
        for (var i = (e = e || this).getElementsByClassName("waves-rippling"), a = 0, r = i.length; a < r; a++) 
          d(t, e, i[a]);
        n && (e.removeEventListener("touchend", l.hide), e.removeEventListener("touchcancel", l.hide)),
  ...
  var c = {
    ...
    registerEvent: function(t) {
      ...
      "touchstart" === e
        ? c.touches += 1
        : /^(touchend|touchcancel)$/.test(e) && setTimeout(function() {
    ...
    if (null !== e) {
      ...
      if (c.registerEvent(t), "touchstart" === t.type && l.delay) {
        var i = !1,
          ...
          r = function(n) {
            a && (clearTimeout(a), a = null, l.show(t, e)),
            i || (i = !0, l.hide(n, e)),
            s()
          },
          o = function(t) {
        ...
        l.show(t, e),
        n && (e.addEventListener("touchend", l.hide, !1), e.addEventListener("touchcancel", l.hide, !1)),
  ...
  return t.init = function(t) {
    ...
    n && (e.addEventListener("touchstart", h, !1), e.addEventListener("touchcancel", c.registerEvent, !1), e.addEventListener("touchend", c.registerEvent, !1)),
  ...
  t.attach = function(t, e) {
    ...
    for (var o = 0, s = t.length; o < s; o++) 
      ...
      -1 !== ["input", "img"].indexOf(a) && (u[a](n), n = n.parentElement),
...
!function(t) {
  ...
  t(document).on("blur", n, function(e) {
    ...
    n && a && o && i.siblings("label, i").removeClass("active"),
    r(i)
  }),
  ...
  s.on("keyup keydown", ".materialize-textarea", o)
}(jQuery),
function(t) {
...
function(t) {
  t(".input-default-wrapper").on("change", ".input-default-js", function(e) {
    var i = t(e.target),
      ...
      r = "";
    a && a.length > 1
      ? r = (i.attr("data-multiple-target") || "").replace("{target}", a.length)
      : e.target.value && (r = e.target.value.split("\\").pop()),
    r
      ? n.find(".span-choose-file").html(r)
      : n.html(n.html())
  })
}(jQuery);